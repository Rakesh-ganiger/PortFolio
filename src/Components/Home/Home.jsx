...
const Home = () => {
  ...
  return (
    <div className="text-white flex flex-col md:flex-row w-full h-screen justify-between items-center p-10 md:p-10">
    <div className="md:w-2/4 md:pt-6 flex flex-col items-center md:items-start space-y-4"> {/* Added space-y-4 */}
